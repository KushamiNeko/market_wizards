...
function drawMarketCapitalization() {
  drawWinLoseColumnChart("#market-capitalization", "Market Capitalization");
}
...
function drawUpDownVolumeRatio() {
  drawWinLoseColumnChart("#up-down-volume-ratio", "Up Down Volume Ratio");
}
...
function drawRSRating() {
  drawWinLoseColumnChart("#rs-rating", "RS Rating");
}
...
function drawIndustryGroupRank() {
  drawWinLoseColumnChart("#industry-group-rank", "Industry Group Rank");
}
...
function drawCompositeRating() {
  drawWinLoseColumnChart("#composite-rating", "Composite Rating");
}
...
function drawEPSRating() {
  drawWinLoseColumnChart("#eps-rating", "EPS Rating");
}
...
function drawSMRRating() {
  drawWinLoseColumnChart("#smr-rating", "SMR Rating");
}
...
function drawAccDisRating() {
  drawWinLoseColumnChart("#acc-dis-rating", "Accumulation/Distribution Rating");
}
...
function drawEPSChgLastQtr() {
  drawWinLoseColumnChart("#eps-chg-last-qtr", "EPS % Chg (Last Qtr)");
}
...
function drawLast3QtrsAvgEPSGrowth() {
  drawWinLoseColumnChart("#last-3-qtrs-avg-eps-growth", "Last 3 Qtrs Avg EPS Growth");
}
...
function drawQtrsofEPSAcceleration() {
  drawWinLoseColumnChart("#qtrs-of-eps-acceleration", "# Qtrs of EPS Acceleration");
}
...
function drawEPSEstChgCurrentQtr() {
  drawWinLoseColumnChart("#eps-est-chg-current-qtr", "EPS Est % Chg (Current Qtr)");
}
...
function drawEstimateRevisions() {
  drawWinLoseColumnChart("#estimate-revisions", "Estimate Revisions");
}
...
function drawLastQtrEarningsSurprise() {
  drawWinLoseColumnChart("#last-qtr-earnings-surprise", "Last Quarter % Earnings Surprise");
}
...
function drawThreeYrEPSGrowthRate() {
  drawWinLoseColumnChart("#three-yr-eps-growth-rate", "3 Yr EPS Growth Rate");
}
...
function drawConsecutiveYrsofAnnualEPSGrowth() {
  drawWinLoseColumnChart("#consecutive-yrs-of-annual-eps-growth", "Consecutive Yrs of Annual EPS Growth");
}
...
function drawEPSEstChgforCurrentYear() {
  drawWinLoseColumnChart("#eps-est-chg-for-current-year", "EPS Est % Chg for Current Year");
}
...
function drawSalesChgLastQtr() {
  drawWinLoseColumnChart("#sales-chg-last-qtr", "Sales % Chg (Last Qtr)");
}
...
function drawThreeYrSalesGrowthRate() {
  drawWinLoseColumnChart("#three-yr-sales-growth-rate", "3 Yr Sales Growth Rate");
}
...
function drawAnnualPreTaxMargin() {
  drawWinLoseColumnChart("#annual-pretax-margin", "Annual Pre-Tax Margin");
}
...
function drawAnnualROE() {
  drawWinLoseColumnChart("#annual-roe", "Annual ROE");
}
...
function drawDebtEquityRatio() {
  drawWinLoseColumnChart("#debt-equity-ratio", "Debt/Equity Ratio");
}
...
function drawOff52WeekHigh() {
  drawWinLoseColumnChart("#off-52-week-high", "% Off 52 Week High");
}
...
function drawPricevs50DayMovingAverage() {
  drawWinLoseColumnChart("#price-vs-50-day-moving-average", "Price vs. 50-Day Moving Average");
}
...
function drawFiftyDayAverageVolume() {
  drawWinLoseColumnChart("#fifty-day-average-volume", "50-Day Average Volume");
}
...
function drawChangeInFundsOwningStock() {
  drawWinLoseColumnChart("#change-in-funds-owning-stock", "% Change In Funds Owning Stock");
}
...
function drawQtrsOfIncreasingFundOwnership() {
  drawWinLoseColumnChart("#qtrs-of-increasing-fund-ownership", "Qtrs Of Increasing Fund Ownership");
}
